...
{String msg;
  ...
  Label l3=new Label("Sex(M/F/O):",Label.LEFT);
  Label l4=new Label("Add:",Label.LEFT);
  ...
  Checkbox ck3=new Checkbox("Other",false,cbg);
...
public student()
 {addWindowListener(new myWindowAdapter());
  ...
  add(b1);
  course.add("B.Tech Information Technology");
  course.add("B.tech CSE");
  course.add("B.tech CIVIL");
  course.add("B.tech ICT");
  course.add("B.Com");
  sem.add("1");
  sem.add("2");
  sem.add("3");
